                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Lista de Productos</h4>
                                        ...
                                        <table class="table align-middle table-nowrap" id="customerTable">
                                            ...
                                            <tbody class="list form-check-all">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="status"><span class="badge badge-soft-danger text-uppercase">Agotado</span></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="status"><span class="badge badge-soft-success text-uppercase">Abastecido</span></td>
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            <div class="edit">
                                                                <button class="btn btn-sm btn-success edit-item-btn" data-bs-toggle="modal" data-bs-target="#showModal">Edit</button>
