...
// Init list
var productsTbList = new List("productoTableList", options).on("updated", function (list) {
...
isCount = new DOMParser().parseFromString(
    productsTbList.items.slice(-1)[0]._values.id,
    "text/html"
);

var isValue = isCount.body.firstElementChild.innerHTML;
var previewEditImgProducto = document.getElementById("previewEditImgProducto");

var idField = document.getElementById("id-field"),
    productoNameField = document.getElementById("productoname-field"),
    imagenField = document.getElementById("imagen-field"),
    categoriaField = document.getElementById("categoria-field"),
    marcaField = document.getElementById("marca-field"),
    modeloField = document.getElementById("modelo-field"),
    stockField = document.getElementById("stock-field"),
    precioField = document.getElementById("precio-field"),
    costoField = document.getElementById("costo-field"),
...
function filterContact(isValue) {
    ...
    productsTbList.filter(function (data) {
...
document.getElementById("showModalEditAddProducto")
    .addEventListener("show.bs.modal", function (e) {
        if (e.relatedTarget.classList.contains("edit-item-btn")) {
            ...
            previewEditImgProducto.style.display = "block";
            ...
            document
                .getElementById("showModalEditAddProducto")
                .querySelector(".modal-footer").style.display = "block";
...
document.querySelector("#productoTableList").addEventListener("click", function () {
    refreshCallbacks();
    ischeckboxcheck();
});
...
editBtn.addEventListener("click", function (e) {
    ...
    var editValues = productsTbList.get({
        id: idField.value,
    });
...
function refreshCallbacks() {
    removeBtns.forEach(function (btn) {
        btn.addEventListener("click", function (e) {
            ...
            var itemValues = productsTbList.get({
                id: itemId,
            });
                ...
                if (isdeleteid == itemId) {
                    document
                        ...
                        .addEventListener("click", function () {
                            productsTbList.remove("id", isElem.outerHTML);
        ...
        btn.addEventListener("click", function (e) {
            ...
            itemValues.forEach(function (x) {
                ...
                if (selectedid == itemId) {
                    ...
                    productoNameField.value = x._values.prducto_name;
                    categoriaField.value = x._values.categoria;
                    marcaField.value = x._values.marca;
                    modeloField.value = x._values.modelo;
                    stockField.value = x._values.stock;
                    precioField.value = x._values.precio;
                    costoField.value = x._values.costo; 
                    previewEditImgProducto.src = rutaImg;
