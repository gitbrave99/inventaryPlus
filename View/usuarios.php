    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                            ...
                            <div class="card-body">
                                <div id="usuariosTableList">
                                    ...
                                    <div class="row g-4 mb-3">
                                        <div class="col-sm-auto">
                                            ...
                                            <div>
                                                ...
                                                <button type="button" class="btn btn-success add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModalEditAddEmpleado">
                                    ...
                                    <div class="table-responsive table-card mt-3 mb-1">
                                        <table class="table align-middle table-nowrap" id="usuariosTable">
                                            <thead class="table-light">
                                                <tr>
                                                    ...
                                                    <th class="sort" data-sort="empleado_name">Empleado</th>
                                                    <th class="sort" data-sort="imagen">Imagen</th>
                                                    <th class="sort" data-sort="docunico">Doc único</th>
                                                    <th class="sort" data-sort="direccion">Dirección</th>
                                                    <th class="sort" data-sort="email">Email</th>
                                                    <th class="sort" data-sort="contrasena">Contraseña</th>
                                            ...
                                            <tbody class="list form-check-all">
                                                <tr>
                                                    ...
                                                    <td class="empleado_name">Mary Cousar</td>
                                                    <td>
                                                        <img class="imagen" src="./assets/images/bg-auth.jpg" alt="" width="10px" height="10px">
                                                    </td>
                                                    <td class="docunico">7845965</td>
                                                    <td class="direccion">Santa Ana</td>
                                                    <td class="email">marycousar@gmail.com</td>
                                                    <td class="contrasena">Contraseña</td>
                                                    <td class="telefono">7845-9854</td>
                                                    <td class="rol">Gerente</td>
                                                    <td class="sucursal">sucusalen</td>
                                                    <td class="status"><span class="badge badge-soft-success text-uppercase">Active</span></td>
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            <div class="edit">
                                                                <button class="btn btn-sm btn-success edit-item-btn" data-bs-toggle="modal" data-bs-target="#showModalEditAddEmpleado">Edit</button>
                                                            </div>
                                                            <div class="remove">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="id" style="display:none;"><a href="javascript:void(0);" class="fw-medium link-primary">#VZ21221</a></td>
                                                    <td class="empleado_name">famt Cousar</td>
                                                    <td>
                                                        <img class="imagen" src="./assets/images/bg-auth.jpg" alt="" width="10px" height="10px">
                                                    </td>
                                                    <td class="docunico">784</td>
                                                    <td class="direccion">Chalcuapa</td>
                                                    <td class="email">char@gmail.com</td>
                                                    <td class="contrasena">****</td>
                                                    <td class="telefono">1111-9854</td>
                                                    <td class="rol">Administrador</td>
                                                    <td class="sucursal">ccucusalen</td>
                ...
                <div class="modal fade" id="showModalEditAddEmpleado" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <form>
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="empleadoname-field" class="form-label">Nombre</label>
                                        <input type="text" id="empleadoname-field" class="form-control" placeholder="Enter Name" required />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="docunico-field" class="form-label">Doc único</label>
                                        <input type="text" id="docunico-field" class="form-control" placeholder="Enter description" required />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="contrasena-field" class="form-label">Contraseña</label>
                                        <input type="text" id="contrasena-field" class="form-control" placeholder="78459885" required />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="rol-field" class="form-label">Rol</label>
                                        <input type="text" id="rol-field" class="form-control" placeholder="78459885" required />
                                    </div>
                                    <div class="mb-3">
                                        <label for="sucursal-field" class="form-label">Sucursal</label>
                                        <input type="text" id="sucursal-field" class="form-control" placeholder="78459885" required />
                                    </div>
                                    <div>
...
<script src="assets/js/pages/empleado-list-table.js"></script>
